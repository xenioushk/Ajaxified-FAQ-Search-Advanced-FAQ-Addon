<?php
    ...
    */
    ...
    <div class="wrap faq-wrapper baf-option-panel">
        ...
        <form action="options.php" method="post">
            ...
            <p class="submit">
                <input name="submit" type="submit" class="button-primary" value="<?php esc_html_e('Save Settings', 'afs-addon'); ?>"/>
            </p>
        </form>    
    ...
    **/
    ...
    function afs_search_window_in_settings() {
        ...
        $afs_in_animation = array('bounce' => 'bounce',
                                                    'bounceIn' => 'bounce In',
    ...
    **/
    ...
    function afs_search_window_out_settings() {
        ...
        $afs_out_animation = array('bounce' => 'bounce',
    ...
    **/
    ...
    function afs_settings_submenu() {
        ...
        add_submenu_page(
                'edit.php?post_type=bwl_advanced_faq', esc_html__('Ajaxified FAQ Search Settings.', 'afs-addon'), esc_html__('Ajaxified Search', 'afs-addon'), 'administrator', 'afs-settings', 'afs_settings'
        );        
